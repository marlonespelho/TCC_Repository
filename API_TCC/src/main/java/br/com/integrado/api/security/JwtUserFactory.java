package br.com.integrado.api.security;
...
public class JwtUserFactory {
	 ...
	 * @return JwtUser
	 */
	public static JwtUser create(FuncionarioModel funcionario) {
		return new JwtUser(funcionario.getId(), funcionario.getUsuario(), funcionario.getSenha(),
